...
function init() {
	...
	meshes.planet2 = addPlanet(
		new THREE.Color(0xd7d7d7),
		0.4,
		new THREE.MeshLambertMaterial({ color: 0xff0000, emissive: 0x00ff00 })
	)
...
function animate() {
	...
	//make orbit movements via sin and cos waves
	meshes.planet2.position.x = Math.sin(-tick * 4.3) * 2
